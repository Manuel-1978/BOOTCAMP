...
-- Tiempo de generación: 05-05-2021 a las 14:00:25
...
(1, 'Vista', 'Cube', 'Montain', 1500),
(2, 'Slash', 'Trek', 'Montain', 3699),
...
(1, '123123X', 1, 'John', 'Smith', 'js,ith@gmail.com', '987654321'),
(2, '1278955X', 2, 'Mike', 'Roberts', 'mroberts@gmail.com', '987456718'),
(3, '9875264F', 3, 'Jane', 'Roberts', 'Jroberts@gmail.com', '987456789');
...
ALTER TABLE `repairs`
  ADD PRIMARY KEY (`id`),
  ADD KEY `repairs_ibdk_1` (`part_id`),
...
--
ALTER TABLE `offers`
  ADD CONSTRAINT `parts` FOREIGN KEY (`part_id`) REFERENCES `parts` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `repairs`
  ...
  ADD CONSTRAINT `repairs_ibdk_1` FOREIGN KEY (`part_id`) REFERENCES `parts` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
