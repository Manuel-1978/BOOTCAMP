...
-- Tiempo de generación: 04-05-2021 a las 14:01:27
...
--
ALTER TABLE `parts`
  ADD CONSTRAINT `parts_ibfk_1` FOREIGN KEY (`id`) REFERENCES `offers` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
('root', '[{\"db\":\"Restaurant\",\"table\":\"employees\"},{\"db\":\"bikeshop\",\"table\":\"parts\"},{\"db\":\"bikeshop\",\"table\":\"clients\"},{\"db\":\"bikeshop\",\"table\":\"repairs\"},{\"db\":\"bikeshop\",\"table\":\"bikes\"},{\"db\":\"Restaurant\",\"table\":\"dishes\"}]');
...
('root', '{\"lang\":\"es\",\"Console\\/Mode\":\"collapse\",\"Console\\/Height\":274}');
...
(1, 'Puchero', 'cuchareo', 5.5, 0),
(2, 'Croquetas', 'fritos', 4.5, 0),
(3, 'Lentejas', 'cuchareo', 5.5, 1),
(4, 'Buchones con aliloli', 'fritos', 6.5, 1);
...
(1, 'juan', '4156476768', 'Manager', '123456789f', 'paco@gmail.com'),
(2, 'luisa', '1567864616', 'CEO', '987654321k', 'luisa@yahoo.es'),
(3, 'Paco', '654152344', 'Manager', '789456123f', 'paco@gmail.com');
